                    ...
                    <div className="max-w-7xl mx-auto px-2 ">
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2">
                                <NavLink to="/shopping-carts" className="rounded-full  p-2" activeClassName="bg-orange-600">
                                ...
                                <>
                                    {navigation.map((item) => (
                                        <NavLink
                                            ...
                                            key={item.to}
                                            to={item.to}
                                            className=" text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-orange-400 "
                                            activeClassName=" bg-orange-600 hover:bg-orange-600"
                                        >
                                            {item.name}
                                        </NavLink>
                                    ))}
