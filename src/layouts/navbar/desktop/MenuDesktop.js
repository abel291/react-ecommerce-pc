            ...
            <div className="container">
                ...
                <div className="flex items-center justify-between mt-2 text-sm relative  ">
                    <div className=" flex items-center space-x-10 ">
                        ...
                        <NavLink  activeClassName="border-b-2 border-orange-500" to="/offers">
                            Ofetas
                        </NavLink>
                        <NavLink  activeClassName="border-b-2 border-orange-500" to="/combos">
                            Combos
                        </NavLink>
                        <NavLink  activeClassName="border-b-2 border-orange-500" to="/assemblies">
                            Ensambles
                        </NavLink>
                        <NavLink  activeClassName="border-b-2 border-orange-500" to="/contact-us">
                            Contacto
                        </NavLink>
                        {/* <Link to="/">Tienda</Link> */}
                    </div>
